...
<!-- start header -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    start logo
                    <a class="branding"  title="宋泉河开发平台"><img src="http://static.ghostchina.com/image/b/46/4f5566c1f7bc28b3f7ac1fada8abe.png" alt="宋泉河开发平台"></a>
                    end logo
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img class="img-responsive center-block" src="http://static.ghostchina.com/image/6/d1/fcb3879e14429d75833a461572e64.jpg" alt="1111111">
      <div class="carousel-caption">
       是的发送到
      </div>
    </div>
    <div class="item">
      <img class="img-responsive center-block" src="http://static.ghostchina.com/image/6/d1/fcb3879e14429d75833a461572e64.jpg" alt="2222222">
      <div class="carousel-caption">
        是的发送到
      </div>
    </div>
   <div class="item">
      <img class="img-responsive center-block" src="http://static.ghostchina.com/image/6/d1/fcb3879e14429d75833a461572e64.jpg" alt="3333333">
      <div class="carousel-caption">
       好几个
      </div>
    </div>
	...
	var currentPage;
		...
		function table_data(e) {
			...
			$.each(data, function(index, item) {
				...
				btn_delete.attr("emp_id", item.id);
